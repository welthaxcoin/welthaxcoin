let hasMaintainance = new URLSearchParams(window.location.search).has(
  "maintainance"
);
...
if (!hasMaintainance) {
  setTimeout(function () {
   location.href = "/index.html?maintainance";
  }, 3000);
} else {
  console.log("Hello");
  document.getElementById("content").style.display = "none";
  document.getElementById("maintainance").style.display = "flex";
}
